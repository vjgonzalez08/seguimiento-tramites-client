...
export const getTotalTramitesDevueltos = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/devueltos');
...
export const getTotalTramitesDevueltosConRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/devueltos-con-respuesta');
    return response.data;
  } catch (error) {
...
export const getTotalTramitesDevueltosSinRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/devueltos-sin-respuesta');
    return response.data;
  } catch (error) {
...
export const getCorteDatosSap = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/corte-datos');
    return response.data;
  } catch (error) {
...
export const getTramitesDevueltosCumplen = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/cumplen');
    return response.data;
  } catch (error) {
...
export const getTramitesDevueltosSinRespuestaSla = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/sin-respuesta-sla');
    return response.data;
  } catch (error) {
...
export const getPromedioDiasRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/promedio-respuesta');
    return response.data;
  } catch (error) {
...
export const getPromedioDiasSinRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/promedio-sin-respuesta');
    return response.data;
  } catch (error) {
...
export const getDevueltosPorPrediadorResumen = async () => {
  try {
    const response = await axios.get('/mutaciones1y5/prediadores/resumen');
    return response.data;
  } catch (error) {
...
export const getDevueltosPorPrediadorDetalle = async (params = {}) => {
  try {
    ...
    const response = await axios.get(`/mutaciones1y5/prediadores/detalle?${query.toString()}`);
    return response.data;
  } catch (error) {
