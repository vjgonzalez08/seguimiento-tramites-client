...
export const getTotalTramitesDevueltos = async () => {
  try {
    const response = await axios.get('/mutaciones/devueltos');
...
export const getTotalTramitesDevueltosConRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones/devueltos-con-respuesta');
    return response.data;
  } catch (error) {
...
export const getTotalTramitesDevueltosSinRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones/devueltos-sin-respuesta');
    return response.data;
  } catch (error) {
...
export const getCorteDatosSap = async () => {
  try {
    const response = await axios.get('/mutaciones/corte-datos');
    return response.data;
  } catch (error) {
...
export const getTramitesDevueltosCumplen = async () => {
  try {
    const response = await axios.get('/mutaciones/cumplen');
    return response.data;
  } catch (error) {
...
export const getTramitesDevueltosSinRespuestaSla = async () => {
  try {
    const response = await axios.get('/mutaciones/sin-respuesta-sla');
    return response.data;
  } catch (error) {
...
export const getPromedioDiasRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones/promedio-respuesta');
    return response.data;
  } catch (error) {
...
export const getPromedioDiasSinRespuesta = async () => {
  try {
    const response = await axios.get('/mutaciones/promedio-sin-respuesta');
    return response.data;
  } catch (error) {
...
export const getDevueltosPorPrediadorResumen = async () => {
  try {
    const response = await axios.get('/mutaciones/prediadores/resumen');
    return response.data;
  } catch (error) {
...
export const getDevueltosPorPrediadorDetalle = async (params = {}) => {
  try {
    ...
    const response = await axios.get(`/mutaciones/prediadores/detalle?${query.toString()}`);
    return response.data;
  } catch (error) {
