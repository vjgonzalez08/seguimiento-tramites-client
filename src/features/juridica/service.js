...
export const getTotalTramitesDevueltos = async () => {
  try {
    const response = await axios.get('/juridica/devueltos');
...
export const getTotalTramitesDevueltosConRespuesta = async () => {
  try {
    const response = await axios.get('/juridica/devueltos-con-respuesta');
    return response.data;
  } catch (error) {
...
export const getTotalTramitesDevueltosSinRespuesta = async () => {
  try {
    const response = await axios.get('/juridica/devueltos-sin-respuesta');
    return response.data;
  } catch (error) {
...
export const getCorteDatosSap = async () => {
  try {
    const response = await axios.get('/juridica/corte-datos');
    return response.data;
  } catch (error) {
...
export const getTramitesDevueltosCumplen = async () => {
  try {
    const response = await axios.get('/juridica/cumplen');
    return response.data;
  } catch (error) {
...
export const getTramitesDevueltosSinRespuestaSla = async () => {
  try {
    const response = await axios.get('/juridica/sin-respuesta-sla');
    return response.data;
  } catch (error) {
...
export const getPromedioDiasRespuesta = async () => {
  try {
    const response = await axios.get('/juridica/promedio-respuesta');
    return response.data;
  } catch (error) {
...
export const getPromedioDiasSinRespuesta = async () => {
  try {
    const response = await axios.get('/juridica/promedio-sin-respuesta');
    return response.data;
  } catch (error) {
...
export const getDevueltosPorPrediadorResumen = async () => {
  try {
    const response = await axios.get('/juridica/prediadores/resumen');
    return response.data;
  } catch (error) {
...
export const getDevueltosPorPrediadorDetalle = async (params = {}) => {
  try {
    ...
    const response = await axios.get(`/juridica/prediadores/detalle?${query.toString()}`);
    return response.data;
  } catch (error) {
