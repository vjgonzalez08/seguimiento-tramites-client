...
} from '@/features/mutaciones23y4/service';
...
const exportPrediadorDetalleToExcel = async () => {
  ...
  try {
    ...
    const excelRows = allRows.map((r) => {
      ...
      return {
        'Gestor Recibe': r.prediador_nombre || '',
        'Usuario SAP Gestor': r.prediador_sap || '',
    ...
    const fileName = `tramites_devueltos_gestores_${yyyy}-${mm}-${dd}.xlsx`;
...
*/
  ...
  /* OPCIONES GRÁFICA DE BARRA X GESTOR */
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{ fontSize: '0.7rem', color: '#6b6b6b', marginTop: '1.4rem', textAlign: 'left',width: '100%', }}>
            Total trámites devueltos de revisor a gestor y su estado de respuesta
          </div>          
        </div>
        ...
        {/* =========================
            BLOQUE 5 — Trámites devueltos a gestore
          ========================= */}
        <div
          style={{
            background: '#ffffff',
        ...
        >
          <div style={{ fontSize: '1.1rem', fontWeight: 750, marginBottom: 12 }}>
            Trámites devueltos a gestores
          </div>

          <div style={{ fontSize: '0.8rem', color: '#6b6b6b', marginBottom: 12 }}>
            Total de trámites devueltos por gestores (ordenado de mayor a menor)
          </div>
        ...
        <div style={{ marginTop: '1.5rem', marginBottom: '3rem' }}>
          ...
          <Table
            ...
            columns={[
              { title: 'Gestor', dataIndex: 'prediador_nombre', key: 'prediador_nombre', sorter: true },
              { title: 'SAP Gestor', dataIndex: 'prediador_sap' },
        ...
        {SHOW_OLD_CARDS && (
          ...
          >
            <CardIndicador
              ...
              tooltip="Trámites devueltos por Revisor a Gestor"
              valor={total}
              texto="Total de trámites devueltos por Revisor a Gestor"
            />
            <CardIndicador
              emoji=""
              titulo="Devueltos con Respuesta"
              tooltip="Trámites devueltos por Revisor a Gestor con respuesta de Gestor"
            ...
            <CardIndicador
              ...
              tooltip="Trámites devueltos por Revisor a Gestor sin respuesta de Gestor"
              valor={totalSinRespuesta}
              texto="Pendientes de respuesta del Gestor"
            />
