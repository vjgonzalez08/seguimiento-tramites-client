...
import {
  ...
  getDevueltosPorPrediadorResumen, // BLOQUE 5 Gráfica detalle x abogado
  getDevueltosPorPrediadorDetalle, // BLOQUE 5 Tabla detalle x abogado
} from '@/features/juridica/service';
...
const exportPrediadorDetalleToExcel = async () => {
  ...
  try {
    ...
    const excelRows = allRows.map((r) => {
      ...
      return {
        'Abogado Recibe': r.prediador_nombre || '',
        'Usuario SAP Abogado': r.prediador_sap || '',
    ...
    const fileName = `tramites_devueltos_abogados_${yyyy}-${mm}-${dd}.xlsx`;
...
*/
  ...
  /* OPCIONES GRÁFICA DE BARRA X ABOGADO */
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{ fontSize: '0.7rem', color: '#6b6b6b', marginTop: '1.4rem', textAlign: 'left',width: '100%', }}>
            Total trámites devueltos de revisor a abogado y su estado de respuesta
          </div>          
        </div>
        ...
        {/* =========================
            BLOQUE 5 — Trámites devueltos a abogados
          ========================= */}
        <div
          style={{
            background: '#ffffff',
        ...
        >
          <div style={{ fontSize: '1.1rem', fontWeight: 750, marginBottom: 12 }}>
            Trámites devueltos a abogados
          </div>

          <div style={{ fontSize: '0.8rem', color: '#6b6b6b', marginBottom: 12 }}>
            Total de trámites devueltos por abogados (ordenado de mayor a menor)
          </div>
        ...
        <div style={{ marginTop: '1.5rem', marginBottom: '3rem' }}>
          ...
          <Table
            ...
            columns={[
              { title: 'Abogado', dataIndex: 'prediador_nombre', key: 'prediador_nombre', sorter: true },
              { title: 'SAP Abogado', dataIndex: 'prediador_sap' },
        ...
        {SHOW_OLD_CARDS && (
          ...
          >
            <CardIndicador
              ...
              tooltip="Trámites devueltos por Revisor a Abogado"
              valor={total}
              texto="Total de trámites devueltos por Revisor a Abogado"
            />
            <CardIndicador
              emoji=""
              titulo="Devueltos con Respuesta"
              tooltip="Trámites devueltos por Revisor a Abogado con respuesta de Abogado"
            ...
            <CardIndicador
              ...
              tooltip="Trámites devueltos por Revisor a Abogado sin respuesta de Abogado"
              valor={totalSinRespuesta}
              texto="Pendientes de respuesta del Abogado"
            />
